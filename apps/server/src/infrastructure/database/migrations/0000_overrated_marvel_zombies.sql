...
CREATE UNIQUE INDEX "auth_account_issuer_account_idx" ON "auth_account" USING btree ("issuer","account_id");--> statement-breakpoint
...
CREATE INDEX "projects_owner_created_idx" ON "projects" USING btree ("owner_id","created_at","id");